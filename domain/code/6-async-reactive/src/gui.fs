...
module Section3 = 
  let up = document.getElementById("up2") :?> HTMLButtonElement
  let down = document.getElementById("down2") :?> HTMLButtonElement
  let lbl = document.getElementById("out2") :?> HTMLParagraphElement
  let stop = document.getElementById("stop") :?> HTMLButtonElement
  let start = document.getElementById("start") :?> HTMLButtonElement

module Section4 = 
  let light = document.getElementById("light2") :?> HTMLDivElement
